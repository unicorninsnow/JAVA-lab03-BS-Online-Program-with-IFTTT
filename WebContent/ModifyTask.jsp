...
<head>
	...
	<link href="css/ModifyTask.css" rel="stylesheet" media="screen">
	<script type="text/javascript" src="js/ModifyTask.js"></script>
...
<body>
		...
		<div class="col-xs-4 col-sm-3 userInfoButton">
			<div class="dropdown userInfoButtonDropdownMenu">
				<a id="userInfoDropdownMenu" class="userInfoButtonDropdown" data-toggle="dropdown" data-target="#"
					href="/page.html"><%=userNameLogIn%></a>
	...
	<div class="modify-Task-info">
		<div class="container modify-Task-info_title">
			<h1>New Task!</h1>
		</div>
		<br/>
		<hr/>
	...
	<div class="modify-Task">
		...
		<!-- modifyTask Step0 显示 提示选择信息 -->
		<div class="modify-Task-Step0" id="modifyTaskStep0">
			if<span style="display: none"></span><a href="#" 
				onclick="goToTHIS();">THIS</a>then<span style="display: none"></span>THAT<span
				style="display: none"></span>
		</div>

		<!-- modifyTask Step1  选择THIS Trigger -->
		<!-- 0表示定时  1表示email  2表示weibo -->
		<div class="modify-Task-Step1" id="modifyTaskStep1">
			<hr/>
		...
		<!-- modifyTask Step2  进行Trigger详细信息的填写 -->
		<div class="modify-Task-Step2" id="modifyTaskStep2">
		
			<!-- 当Trigger为定时任务时 显示的Trigger详细输入体 -->
			<div class="modify-Task-Step2-datetime" id="modifyTaskStep2-datetime">
				<hr/>
				<div class="container">
			...
			<div class="modify-Task-Step2-email" id="modifyTaskStep2-email">
				<hr/>
				<div class="container">
			...
			<div class="modify-Task-Step2-weibo" id="modifyTaskStep2-weibo">
				<hr/>
				<div class="container">
		...
		<!-- modifyTask Step3 显示已选好的THIS Trigger  并提示用户前往选择THAT的div -->
		<div class="modify-Task-Step3" id="modifyTaskStep3">
			<hr/>
		...
		<!-- modifyTask Step4 选择THAT Action -->
		<div class="modify-Task-Step4" id="modifyTaskStep4">
			<hr/>
		...
		<!-- modifyTask Step5  进行Action详细信息的填写 -->
		<div class="modify-Task-Step5" id="modifyTaskStep5">
		
			<!-- 当Action为发邮件时 显示的Action详细输入体 -->
			<div class="modify-Task-Step5-email" id="modifyTaskStep5-email">
				<hr/>
				<div class="container">
					Send Email:
				</div>
			...
			<div class="modify-Task-Step5-weibo" id="modifyTaskStep5-weibo">
				<hr/>
				<div class="container">
					Update Weibo:
				</div>
		...
		<!-- modifyTask Step6   显示已选好的Trigger 和 Action -->
		<div class="modify-Task-Step6" id="modifyTaskStep6">
			<hr/>
			if<span style="display: none"></span><a class="THIS_img" id="THIS_Task">
					<img name="THIS_Task_img" src="">
		...
		<div class="modify-Task-Step7" id="modifyTaskStep7">
			<hr/>
			<div class="container" style="text-align: center;font-size: 40px;">
				Modify the Task Name:<br/>
				<input class="input-xlarge" id="taskNameText" size="16" type="text" placeholder="TaskName" style="font-size: 30px;"><br/>
				<div class="col-md-4 col-md-offset-4" style="padding-top: 5px;text-align:center;">
					<button type="button" class="btn btn-lg btn-success button-task-confirm" 
						onclick="modifyTask()">Modify Task</button>
				</div>
			</div>
		</div>
