		...
		<div class="container">
			...
			<div class="col-xs-4 col-sm-3">
				...
				<div class="dashboard_tasknum">
					<span id="TaskAllNum">0</span> Tasks in Total<br>
		...
		<div class="container ">
			<div id="myTabContent" class="tab-content">
				...
				<div class="tab-pane fade" id="messages">
					<div class="panel panel-default" id="messages_panel">
						<!-- Default panel contents -->
						<div class="panel-heading" style="font-size: 20px;">Messages Here! -- All messages are list here.</div>
							...
							<table class="table"  id="messagesTable"
								...
								<thead style="text-align: center;">
									<tr>
										...
										<th width="20px" style="text-align: center;"></th>
										<th>Messages</th>
										<th width="100px" style="text-align: center;">Sender</th>
										<th width="100px" style="text-align: center;">Sender</th>
										<th width="100px" style="text-align: center;">Receiver</th>
										<th width="100px" style="text-align: center;">Operation</th>
									</tr>
								</thead>
								<tbody id="messagesTable_tbody" style="text-align: center;">
