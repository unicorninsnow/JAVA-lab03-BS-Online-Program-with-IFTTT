 ...
 * 根据任务ID修改任务
 * 
 * @author mzs created on 2013-12-20 00：06
 */
public class ModifyTask extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			boolean flag = opObj.modifyTask(taskID, taskName, taskDeadTime, taskTHISType, taskTHATType, srcMailBox,
					srcMailPassWd, updateWeiboID, updateWeiboPassWd, dstMailBox, listenWeiboID, listenWeiboPassWd,
					content, mailSubject, weiboCheckCon);
			out.print(flag);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		try {
			...
			out.print("error NumberFormatException");
		} catch (Exception e) {
